...
if Exodian or ExodianV2Loaded then
    return
end
...
local Aimbot, WallHack = getgenv().Exodian.Aimbot, getgenv().Exodian.WallHack
...
FunctionsSection:AddButton({
	...
	Callback = function()
		setclipboard("https://github.com/Exunys/Exodian")
	end
})
...
do
	...
	Aux.OnInvoke = function(Answer)
		...
		Library.Unload()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/Exunys/Exodian-V2/main/src/Main.lua"))()
	end

	game.StarterGui:SetCore("SendNotification", {
		Title = "🎆  Exodian V2  🎆",
		Text = "Would you like to use the new Exodian V2 script?",
		Button1 = "Yes",
		Button2 = "No",
		Duration = 1 / 0,
