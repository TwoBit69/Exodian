--[[
	...
	Aimbot Module [Exodian] by Exunys © CC0 1.0 Universal (2023)
...
if not getgenv().Exodian or getgenv().Exodian.Aimbot then return end
...
local Environment = getgenv().Exodian.Aimbot
...
function Environment.Functions:Exit()
	...
	getgenv().Exodian.Aimbot.Functions = nil
	getgenv().Exodian.Aimbot = nil
