--[[
	...
	Wall Hack Module [Exodian] by Exunys © CC0 1.0 Universal (2023)
...
if not getgenv().Exodian or getgenv().Exodian.WallHack then return end
...
local Environment = getgenv().Exodian.WallHack
...
function Environment.Functions:Exit()
	...
	getgenv().Exodian.WallHack.Functions = nil
	getgenv().Exodian.WallHack = nil
